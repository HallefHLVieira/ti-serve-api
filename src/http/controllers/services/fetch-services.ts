import { makeFetchFollowersByServiceUseCase } from '@/domain/use-cases/factories/make-fetch-followers-by-service-use-case'
import { makeFetchServicesUseCase } from '@/domain/use-cases/factories/make-fetch-services-use-case'
